...
export const Header = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 shadow-[0_1px_8px_rgba(0,0,0,0.06)] bg-vivero-badge-stock">
          <div className="relative p-4 md:px-8 md:py-6 max-w-[1280px] mx-auto px-space-md lg:px-space-xl flex items-center justify-between gap-space-md">
            ...
            <div className="hidden relative xl:block w-72 group">
              <div className="flex items-center bg-surface-container-lowest rounded-full px-space-sm py-space-xxs shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
                <span className="material-symbols-outlined text-outline text-[18px] mr-space-xxs">
                  search
                </span>
                <input
            ...
            <div className="flex items-center gap-space-sm shrink-0">
              <a
                className="inline-flex items-center gap-space-xs bg-primary text-on-primary hover:bg-primary-container px-space-md py-space-xs rounded-full font-label-md text-label-md transition-all"
