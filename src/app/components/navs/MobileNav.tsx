...
export const MobileNav = () => {
  ...
  return (
    <>
        <button onClick={handleClick} type="button" aria-expanded={btnStatus} className="p-1 flex flex-col align-middle bg-transparent rounded-sm border-outline md:hidden">
        ...
        <nav className="absolute top-[64px] left-0 items-center gap-space-lg shadow-elevated w-full bg-vivero-badge-stock md:hidden" hidden={btnStatus ? false : true}>
